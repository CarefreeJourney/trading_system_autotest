...
class GoodsPage(GoodsBase, ObjectMap):
    def input_goods_title(self, driver, input_value):
        ...
        return self.element_fill_value(driver
                                       , By.XPATH,
                                       goods_title_xpath,
                                       input_value)
    ...
    def input_goods_details(self, driver, input_value):
        ...
        return self.element_fill_value(driver, By.XPATH,
                                       goods_details_xpath,
                                       input_value)
    ...
    def select_goods_num(self, driver, num):
        ...
        :return:
        """
        goods_num_add_xpath = self.goods_number(plus=True)
        for i in range(num):
